...
class ai_respond extends \core\event\base {
    ...
    public function get_description() {
        return "AI has graded the attempt of user with id '$this->relateduserid'" .
        "On course with id '$this->courseid'";
    }
